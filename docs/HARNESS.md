...
- Docs on disk: files_convert / files_find / xlsx / read_url. Memory: memory_add / memory_search. History: recall (Screenpipe). Graph: todo / onenote / teams / mail_send. git / gh_pr.

...
OPS: List[Dict[str, Any]] = [
    ...
    {"op": "wait", "aliases": ["wait_until"], "lease": False,
     "purpose": "Wait for text/control", "fields": ["text?", "query?", "timeout?", "poll?"]},
    ...
    {"op": "click", "aliases": ["smart_click"], "lease": True,
     "purpose": "UIA-first click by query (or x,y)", "fields": ["query?", "x?", "y?", "require_change?"]},
    {"op": "type", "aliases": ["smart_type"], "lease": True,
     "purpose": "Type text (optional focus query)", "fields": ["text", "query?", "clear?", "confirm?"]},
    ...
    {"op": "window_close", "aliases": [], "lease": True, "purpose": "Close window", "fields": ["title?", "hwnd?"]},
    ...
    {"op": "proc_kill", "aliases": [], "lease": True,
     "purpose": "Kill process (confirm; anti-cheat hard-deny)", "fields": ["pid", "confirm"]},

...
OPS: List[Dict[str, Any]] = [
    ...
    {"op": "gh_pr", "aliases": ["github_pr", "pr_status"], "lease": False,
     ...
     "fields": ["repo", "number?"]},
    {"op": "docling", "aliases": ["docling_convert"], "lease": False,
     "purpose": "Allowrooted file → markdown (Docling; txt/json/csv/html builtin)",
     "fields": ["path", "verbose?"]},
    ...
    {"op": "steel_stop", "aliases": [], "lease": False,
     ...
     "fields": ["id"]},
    {"op": "tavily", "aliases": ["tavily_search"], "lease": False,
     "purpose": "Tavily web search (TAVILY_API_KEY)",
     "fields": ["query", "max?"]},
    {"op": "exa", "aliases": ["exa_search"], "lease": False,
     "purpose": "Exa web search (EXA_API_KEY)",
     "fields": ["query", "max?"]},
    ...
    {"op": "print", "aliases": ["print_file"], "lease": False,
     "purpose": "Print an allowrooted file (confirm=true)",
     "fields": ["path", "confirm"]},
    ...
    {"op": "dialog", "aliases": ["message_box"], "lease": False,
     "purpose": "Show a Windows message box (confirm=true)",
     "fields": ["text", "confirm"]},
...
HARNESS_RULES: List[str] = [
    ...
    "docling / rag = local docs. tavily / exa / steel_start = HTTP search/browser. slack/notion/linear posts need confirm.",

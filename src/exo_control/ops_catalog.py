...
HARNESS_RULES: List[str] = [
    ...
    "volume/winget/recycle/eventlog/tts are Windows desk ops (set/empty need confirm). ocr_win and stt are stubs (see ready).",
    ...
    "ready is the honest map (works here / Windows-native / needs a key). Windows desk ops use stock natives except ocr_win/stt stubs, not silent UNAVAILABLE.",

...
OPS: List[Dict[str, Any]] = [
    ...
    {"op": "ddg", "aliases": ["duckduckgo"], "lease": False,
     "purpose": "DuckDuckGo instant answers (no key)",
     "fields": ["query"]},
    ...
    {"op": "serper", "aliases": ["serper_search"], "lease": False,
     "purpose": "Serper Google search (SERPER_API_KEY)",
     "fields": ["query", "max?"]},
    {"op": "brave", "aliases": ["brave_search"], "lease": False,
     "purpose": "Brave Search (BRAVE_API_KEY)",
     "fields": ["query", "max?"]},
    ...
    {"op": "files_mkdir", "aliases": ["mkdir"], "lease": False,
     ...
     "fields": ["path"]},
    {"op": "files_stat", "aliases": ["stat"], "lease": False,
     "purpose": "Stat an allowrooted path",
     "fields": ["path"]},
    ...
    {"op": "pdf_info", "aliases": [], "lease": False,
     "purpose": "PDF header/size for an allowrooted file",
     "fields": ["path"]},
    {"op": "image_info", "aliases": [], "lease": False,
     "purpose": "Image suffix/size for an allowrooted file",
     "fields": ["path"]},
    ...
    {"op": "browser_dialog", "aliases": [], "lease": True,
     "purpose": "Arm accept/dismiss for the next JS dialog",
